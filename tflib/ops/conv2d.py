...
def Conv2D(name, input_dim, output_dim, filter_size, inputs, he_init=True,
           mask_type=None, stride=1, weightnorm=None, biases=True, gain=1., spectral_norm=False):
    """
    ...
    with tf.name_scope(name) as scope:
        ...
        if spectral_norm:
            filters = spectral_normed_weight(filters)
