...
def params_with_name1(name1, name2):
    return [p for n,p in _params.items() if name1 or name2 in n]

def params_with_name2(name1, name2, name3):
    return [p for n,p in _params.items() if name1 or name2 or name3 in n]
